...
1. **[安装](/en/cline/install)** — 选择你的 IDE 平台完成安装
2. **[配置模型](/en/cline/models)** — 选择合适的 AI 模型和提供商
3. **[上下文管理](/en/cline/context)** — 理解焦点链、自动压缩、截断机制
4. **[核心特性](/en/cline/features)** — 掌握 Plan/Act、差异编辑、@提及、规则、MCP 等
