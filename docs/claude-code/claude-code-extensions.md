...
![六大扩展模块 + Plugins 打包分发](/images/claude-code/extensions/01-toolbox-pack.png)
...
* 推荐插件：官方提供 typescript-lsp（TS 智能提示）、pyright-lsp（Python 类型检查）、hookify（Hook 快速生成）等插件，可通过 marketplace 安装，示例命令为 claude plugin marketplace add [https://github.com/mixedbread-ai/mgrep。](https://github.com/mixedbread-ai/mgrep%E3%80%82)
...
![扩展不是越多越好：只选需要的，轻装上阵](/images/claude-code/extensions/02-cost-control.png)
