...
![把高频操作固化成技能胶囊：一次配置，终身复用](/images/claude-code/skills/01-skill-capsule.png)
...
![技能的核心是 SKILL.md：YAML 元数据 + 执行指令](/images/claude-code/skills/02-skill-md.png)
...
辅助脚本（[visualize.py](http://visualize.py)）简化示例：
